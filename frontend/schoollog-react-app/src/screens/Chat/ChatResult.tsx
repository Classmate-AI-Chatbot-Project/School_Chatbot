...
function StudentResult() {
  ...
  const postResult = () => {
    //전체 결과 전송
    axios
      .post(`${API_BASE_URL}:8000/chat/result/${user_id}/${chatroom_id}/`, responseData, {
        headers: {
  ...
  const gotoConsult = () => {
    axios
      .get(`${API_BASE_URL}:8000/consult/redirect_room/`, {
        headers: {
          'Content-type': 'application/json',
        },
        withCredentials: true,
      ...
      <div className="Chat-ContenBox">
          ...
          <div className="Result1-clipboard">
            ...
            <div className="Result1-chart">
              ...
              <ApexChart
                ...
                width={320}
              />
              <span className="R1-Hp">{Math.round(100 - depressionCount)}%</span>
              <span className="R1-Gp">{Math.round(depressionCount)}%</span>
            </div>
          </div>
        </div>
        ...
        <div className="Result3-keyword">
          ...
          <div className="Result3-box">
            {wordcloudImage && (
              <img
                src={`${API_BASE_URL}:8000/` + correctedImagePath}
                alt="Wordcloud"
        ...
        <div className="Result4-summary">
          ...
          <div className="Result4-box">
            <div className="Result4-box2">{summaryText}</div>
          </div>
        </div>
        ...
        <div className="StudentResult-end">
          {showTooltip && (
            <div className="StudentResult-tooltip">
              ...
              <button className="StudentResult-closeBtn" onClick={closeTooltip}>
                ✖
              </button>
            </div>
          )}
          <Link to="/profile">
            <button
              className="StudentResult-endBtn"
              onClick={() => {
                postResult();
              }}
            >
